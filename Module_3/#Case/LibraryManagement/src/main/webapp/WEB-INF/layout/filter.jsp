  ...
  <div class="dropdown">
    <button class="btn btn-sm btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton1"
      ...
      <c:choose>
        ...
        <c:when test="${param['deleted']==false}">Chưa xoá</c:when>
    ...
    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
      ...
      <li><a class="dropdown-item" href="/${requestScope['view']}?action=${param.action}<%=request.getParameter("q")!=null?"&q="+request.getParameter("q"):""%>&deleted=false">Chưa xoá</a></li>
